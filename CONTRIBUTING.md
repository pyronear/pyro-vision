...
- [pyrovision](./pyrovision) - The actual package codebase
- [references](./references) - Training scripts to reproduce performances
- [docs](./docs) - Documentation building files
- [tests](./tests) - Python unit tests
- [demo](./demo) - the code to run the live demo
...
If you are wondering how to do something with Pyro-Vision, or a more general question, you should consider checking out Github [discussions](https://github.com/pyronear/pyro-vision/discussions). See it as a Q&A forum, or the Pyro-Vision-specific StackOverflow!
...
1 - Fork this [repository](https://github.com/pyronear/pyro-vision) by clicking on the "Fork" button at the top right of the page. This will create a copy of the project under your GitHub account (cf. [Fork a repo](https://docs.github.com/en/get-started/quickstart/fork-a-repo)).
...
```shell
git clone git@github.com:<YOUR_GITHUB_ACCOUNT>/pyro-vision.git
cd pyro-vision
